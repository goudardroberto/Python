...
Podemos começar uma variável composta de 3 maneiras -> (), [], {}
...
# Forma 2 - É mais usado para mostrar o índice
lanche = ('Hambúrguer', 'Suco', 'Pizza', 'Pudim')
for i in range(len(lanche)):
    print(f'Eu vou comer {i, lanche[i]}')
print('Comi pra caramba!')

# Forma 3 - Ou usamos o enumerate
lanche = ('Hambúrguer', 'Suco', 'Pizza', 'Pudim')
for pos, comida in enumerate(lanche):
    print(f'Eu vou comer {comida} na posição {pos}')
print('Comi pra caramba!')

# Sorted para ordenar -> Não manipula a tupla, apenas apresenta ela de forma ordenada
print(lanche)
print(sorted(lanche))

# Index para verificar a posição do elemento, passamos o valor, ele retorna o índice
lanche = ('Hambúrguer', 'Suco', 'Pizza', 'Pudim')
...
c = a + b
print(c)
print(c.index(5)) # Ele sempre pega o primeiro elemento

# Apagando a tupla toda, não é aceito deletar um item somente
del(c)
print(c)
"""
